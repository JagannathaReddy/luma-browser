...
function apiTarget(action) {
    ...
    if (action.class === 'Locator' && action.params.selector) {
        return (internalSelectorToExpression(action.params.selector) ??
...
function formatArgs(action) {
    ...
    else if (action.params.selector != null &&
...
//# sourceMappingURL=export-script.js.map