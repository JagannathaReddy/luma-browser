...
import { dataDir, daemonLogPath, getSocketPath, pidPath, requiresSocketCleanup, sessionsDir, tempDir, } from '../paths.js';
...
export function createDaemon({ manager = new BrowserManager(), sessions = new SessionManager(), paths = {
    socketPath: getSocketPath(),
    pidPath,
    sessionsDir,
    requiresSocketCleanup,
    unlinkIfExists,
}, version = getPackageVersion, log = logger, } = {}) {
