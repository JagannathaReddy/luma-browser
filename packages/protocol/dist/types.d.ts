...
export type Request = ExecuteRequest | SessionRunRequest | SessionStartRequest | SessionEndRequest | SessionAbortRequest | SimpleRequest<'session-list'> | SimpleRequest<'browsers'> | BrowserStopRequest | SimpleRequest<'status'> | SimpleRequest<'install'> | SimpleRequest<'stop'>;
...
export type TypedRequest<T extends RequestType> = Extract<Request, {
    type: T;
}>;
